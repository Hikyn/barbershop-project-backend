...
router.get('/:userid', tryCatch(async function(req, res, next) {
...
router.put('/:userid', tryCatch(async function(req, res, next) {
...
router.delete('/:userid', tryCatch(async function(req, res, next) {
